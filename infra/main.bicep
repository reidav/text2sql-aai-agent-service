...
module sql './core/database/azsql.bicep' = {
  name: 'az-sql'
  scope: resourceGroup
  params: {
    location: location
    serverName: 'sql-${resourceToken}'
    sqlIdentityName: managedIdentity.outputs.managedIdentityName
    sqlDBName: 'sqldb-${resourceToken}'
    applicationDatabaseAdminsObjectId: principalId
    applicationDatabaseAdminsLoginName: 'me@davidrei.xyz'
    tags: tags
  }
}
